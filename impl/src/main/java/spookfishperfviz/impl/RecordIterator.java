...
final class RecordIterator implements Iterator<Record>, AutoCloseable {
	...
	static RecordIterator create(Reader source, RecordParser parser) {
	...
	private RecordIterator(Reader source, RecordParser parser) {
	...
	private Record readNextRecord() {
		...
		var record = this.parser.parse(line);
